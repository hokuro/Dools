...
public class GuiDoolPause_evocation_illager extends GuiDoolPause {
	public EntityEvoker entity;
	public String[] button101 = {"Spell On","Spell OFF"};


	public GuiDoolPause_evocation_illager(EntityDool entityfigure) {
		super(entityfigure);
		entity = (EntityEvoker)entityfigure.renderEntity;
	}
