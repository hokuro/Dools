...
public class GuiDoolPause_zombie_villager extends GuiDoolPause {
	...
	private ZombieVillagerEntity entity;
	...
	public GuiDoolPause_zombie_villager(EntityDool entityfigure) {
		super(entityfigure);
		entity = (ZombieVillagerEntity)entityfigure.renderEntity;
		indexProfession = 0;
		indexType = 0;
		level = 1;
	}
	...
	protected void actionPerformed(int id, Button button) {
		...
		case 101:
			...
			entity.func_213792_a(entity.getVillagerData().withProfession(professions.get(indexProfession)));
		...
		case 102:
			...
			entity.func_213792_a(entity.getVillagerData().withType(villagerType.get(indexType)));
		...
		case 103:
			...
			entity.func_213792_a(entity.getVillagerData().withLevel(level));
