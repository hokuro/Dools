...
public class ServerDool_pufferfish extends ServerDool {
	@Override
 	public void sendData(EntityDool pFigure, DataOutput pData) throws IOException {
		super.sendData(pFigure, pData);
		PufferfishEntity entity = (PufferfishEntity)pFigure.renderEntity;
		pData.writeInt(entity.getPuffState());
	}
	...
	@Override
 	public void reciveData(EntityDool pFigure, DataInput pData) throws IOException {
		...
		PufferfishEntity entity = (PufferfishEntity)pFigure.renderEntity;
		entity.setPuffState(pData.readInt());
	}
