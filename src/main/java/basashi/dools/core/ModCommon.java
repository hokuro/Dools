...
public final class ModCommon {
	...
	// モッド名
	public static final String MOD_NAME = "Dools";
	public static final String MOD_PACKAGE = "basashi.dools";
	public static final String MOD_CLIENT_SIDE = ".client.ClientProxy";
	public static final String MOD_SERVER_SIDE = ".core.CommonProxy";
	public static final String MOD_FACTRY = ".client.config.DoolsGuiFactory";
