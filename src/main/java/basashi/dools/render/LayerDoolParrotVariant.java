...
@OnlyIn(Dist.CLIENT)
public class LayerDoolParrotVariant<T extends EntityDoolPlayer> extends LayerRenderer<T, PlayerModel<T>> {
	private final ParrotModel field_215346_a = new ParrotModel();
	public LayerDoolParrotVariant(IEntityRenderer<T, PlayerModel<T>> p_i50929_1_) {
		super(p_i50929_1_);
	}
