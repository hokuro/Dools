...
@OnlyIn(Dist.CLIENT)
public class LayerDoolCape extends LayerRenderer<EntityDoolPlayer, PlayerModel<EntityDoolPlayer>> {

	public LayerDoolCape(IEntityRenderer<EntityDoolPlayer, PlayerModel<EntityDoolPlayer>> p_i50950_1_) {
		super(p_i50950_1_);
	}

	@Override
	public void render(EntityDoolPlayer entityIn, float p_212842_2_, float p_212842_3_, float p_212842_4_, float p_212842_5_, float p_212842_6_, float p_212842_7_, float p_212842_8_) {
		if (!entityIn.isInvisible() && entityIn.isCape && entityIn.getLocationCape() != null) {
