...
public class SlotArmorDool extends Slot {
	...
	public boolean func_75214_a(ItemStack par1ItemStack) {
		...
		Item litem = par1ItemStack.func_77973_b();

		par1ItemStack.func_77973_b().isValidArmor(par1ItemStack, armorType, ((ContainerItemSelect)parent).openPlayer);

		if (litem instanceof ItemArmor) {
			return ((ItemArmor)litem).field_77881_a == armorType;
		}
		if (Block.func_149634_a(litem) == Blocks.field_150423_aK || litem == Items.field_151144_bL) {
