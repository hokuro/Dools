	...
	public IMessage onMessage(MessageServer_SpawnDool message, MessageContext ctx) {
		try{
			...
			if (message.mobString =="") {
				...
				leitem.func_174869_p();
				lworld.func_72838_d(leitem);
				...
				try {
					...
					lentity = EntityList.func_75620_a(lname, lworld);
					ldool.setRenderEntity((EntityLivingBase)lentity);
					ldool.func_70080_a(lx, ly, lz, lyaw, 0F);
					lworld.func_72838_d(ldool);
					EntityPlayer pl = ctx.getServerHandler().field_147369_b;
					lworld.func_184133_a(pl, new BlockPos(pl.field_70165_t,pl.field_70163_u,pl.field_70161_v), SoundEvents.field_187845_fY, SoundCategory.BLOCKS ,0.5F, 0.4F / ((new Random()).nextFloat() * 0.4F + 0.8F));
